...
public class OrderApiBaseIntegrationTest : IAsyncLifetime
{
    ...
    private readonly OrderApiApplicationTestFactory<Program> _apiFactory;
    private static IServiceScopeFactory _scopeFactory = null!;
    private static BookyWooksOrderDbContext _bookyWooksOrderDbContext = null!;

    public OrderApiBaseIntegrationTest(OrderApiApplicationTestFactory<Program> apiFactory)
    {
