...
public class OrderConstructor
{
  ...
  public static readonly DeliveryAddress DeliveryAddress = DeliveryAddress.Of("Test Street", "Test City", "Test Country", "Test Post");
  public static readonly Payment PaymentDetails = Payment.Of("1234 5678 9012 3456", "Christopher", "12/23", "123", 1);
  public static readonly Customer Customer = Customer.Create("Customer Name", "Unique Email");
  public static readonly Order Order1 = Order.Create(Customer.Id, DeliveryAddress, PaymentDetails);
