...
{
  public static Validation Validate( Guid customerId) => ValueObjectValidation.Validate(customerId, ValidationMessages.CustomerId);
  ...
  {
    private static Validation Validate(string input) => ValueObjectValidation.Validate(input,ValidationMessages.CustomerName,minLength: 1,maxLength: 50);
